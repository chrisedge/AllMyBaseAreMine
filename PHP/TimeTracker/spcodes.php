...
// This is getting Service Provider codes. That '3' below is hard coded based on the Service Provider categories_id being '3' in the
// database.
$globalCodes = getGlobalCodesByCategory('3'); // Located in functions.php
