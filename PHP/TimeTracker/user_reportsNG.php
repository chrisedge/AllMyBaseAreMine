              ...
              <div style="font-size:24px; font-weight:bold; padding-bottom:5px;">
                ...
                <div id="updates">
                  ...
                  Reports for: <span class="err" id="orgLevel"><?php echo ' '.$reportName;?></span>
                    ...
                    <div class="ui-widget-header ui-corner-tl ui-corner-tr" style="margin:0px 5px 0px 5px; padding:5px;">User Reports</div>
                    <div class="ui-widget-content ui-corner-bl ui-corner-br" style="margin:0px 5px 0px 5px; padding:5px;">
