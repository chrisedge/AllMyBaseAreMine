...
// This is getting Company codes. That '1' below is hard coded based on the Company categories_id being '1' in the
// database.
$globalCodes = getGlobalCodesByCategory('1'); // Located in functions.php
