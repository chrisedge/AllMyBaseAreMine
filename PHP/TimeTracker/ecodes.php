...
// This is getting Enterprise codes. That '2' below is hard coded based on the Enterprise categories_id being '2' in the
// database.
$globalCodes = getGlobalCodesByCategory('2'); // Located in functions.php
